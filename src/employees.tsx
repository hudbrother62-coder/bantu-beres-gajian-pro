...
export function EmployeeWorkflow({ profile }: { profile: Profile }) {
  ...
  return <section className="page">
    <div className="intro"><div><p className="eyebrow">Data master</p><h1>Karyawan</h1><p>Personal → kepegawaian → payroll. Draft dapat dilanjutkan kapan saja.</p></div>{canEdit && <button className="button primary" onClick={() => start()}>Tambah karyawan</button>}</div>
